...
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'  # ? Enables gzip & cache busting
...
JAZZMIN_SETTINGS = {
    ...
    # "site_logo": "logo.png",  # Uncomment if you place logo in /static/
